...
**Landing:** the VSF-Image write moves in (format in, `.vsf` out, one call), assumed-observer ingest (JPEG/PNG/TIFF/PSD), and the DNG/TIFF writers migrate over from chameleon. The aperture passes light both directions.
